...
<div class="privacy">
	...
	<p style="width: 350px;">
			...
			<b>Email Address</b>  <input type="email" name="email" class="form-control" id="email" placeholder="abc@example.com" required="">
	</p> 

	<p style="width: 350px;">
		
			<b>Contact No</b>  <input type="text" name="mobile" class="form-control" id="mobile" placeholder="Reg Mobile no" required="">
	</p> 
