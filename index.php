	  ...
	  <span></span><img src="images/about-img.png" alt=""><span></span>
	   ...
	   <div class="container">
		 <div class="col-md-4 about-grids">
			 ...
			 <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras molestie congue sapien, id posuere turpis congue non. Donec porta eros at sapien elementum, non ultrices lacus tempor. Proin orci est, convallis non mattis at, tincidunt nec neque. Mauris egestas dolor in finibus porta. Donec commodo sit amet tellus et auctor. Curabitur</p>
		 </div>
		 <div class="col-md-4 about-grids grid2">
			 <h4><span class="icon2"></span>Our Mission</h4>
			 <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras molestie congue sapien, id posuere turpis congue non. Donec porta eros at sapien</p>
		 </div>
		 <div class="col-md-4 about-grids">
...
<div id="portfolio" class="portfolio">
   <div class="top-tours-head text-center">
	      ...
	      <ul id="filters" class="clearfix wow bounceIn" data-wow-delay="0.4s">
			...
			<li><span class="filter" data-filter="app">Religous</span></li>
			<li><span class="filter" data-filter="card">Cultural</span></li>
			<li><span class="filter" data-filter="icon">Historical</span></li>
			<li><span class="filter" data-filter="fun">Adventurous</span></li>
	        </ul>
...
<?php }?>
	...
	<div class="col-md-3 image-grid">
					 ...
					 <p><a href="https://github.com/samaha-rizvi-4578/WebDevFackCoders">All Rights Resreved - Fack Coders</a></p>
				 </div>
				<?php if($n%4==3)
				{?>
            </div>
		  ...
		  <div class="contact-grids">
			  <div class="container">
				  <div class="col-md-4 address">
						<h4 style="color:#09F">SafarNama</h4>
						<p style="color:#000">NEED HELP BOOKING PACKAGE<br/>
                        For fantastic suggestions you may also call our travel expert</p>
						<h5 style="color:#000"><span class="img1"></span>(+92) 12345678 &nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;123456789</h5>
						<h5 style="color:#000"><span class="img2"></span><a href="#">https://github.com/samaha-rizvi-4578/WebDevFackCoders&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;https://github.com/samaha-rizvi-4578/WebDevFackCoders</a></h5>
